...
import RentHouseItemComponent from './RentHouseItemComponent';
...
class RentHouseComponent extends Component {
    ...
    componentWillMount(){
        ...
        this.setState({
            priceOptions:[
                { label: '1000以下', value: '0-100' },
                { label: '1000-2000元', value: '100-200' },
                { label: '2000-3000元', value: '200-300'},
                { label: '3000-5000元', value: '300-500' },
                { label: '5000-8000', value: '500-800' },
                { label: '8000以上', value: '800'}
            ],
            areaOptions:[
