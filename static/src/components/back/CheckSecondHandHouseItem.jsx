...
class CheckSecondHandHouseItem extends Component{
                    ...
                    <Row style={{margin:'10px 0px 10px 0px'}}>
                        ...
                        <Col span={13} style={{background:'white',fontSize:'14px',margin:'0px 0px 0px 0px'}}>
                            ...
                            <Row style={{height:'36px'}}>
                                ...
                                <Col span={6}><span style={{fontSize:'26px',color:'red',fontWeight:'bold'}}>{this.props.price}</span>&nbsp;万</Col>
                            </Row>
                            <Row style={{height:'34px'}}>
                                ...
                                <Col span={6}>单价<span>{this.props.average}</span>元/平</Col>
                            </Row>
                            <Row style={{height:'34px'}}>
                                <Button　type="primary" onClick={ this.delete}>通过</Button>
                                <Button　type="danger" onClick={ this.delete}>拒绝</Button>
                            </Row>
                        </Col>
                    </Row>
...
export default CheckSecondHandHouseItem;